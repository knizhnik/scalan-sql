...
class Cluster {
  public:
    ...
    Cluster(size_t nodeId, size_t nHosts, char** hosts, size_t nQueues = 64, size_t bufferSize = 64*1024, size_t queueSize = 256*1024*1024, size_t syncInterval = 1024*1024);
    ~Cluster();
